    ...
    for w=1:12
       ...
       for v=1:size(tempHlecc30)
           for u=1:size(tempQlcon30)
                if(tempHlecc30(v,3) == tempQlcon30(u,3))
                   %if (tempHlecc30(v,2) == tempQlcon30(u,2))
    ...
    for w=1:12
       ...
       for v=1:size(tempHrecc30)
           for u=1:size(tempQrcon30)
                if(tempHrecc30(v,3) == tempQrcon30(u,3))
                   %if (tempHrecc30(v,2) == tempQrcon30(u,2))
    ...
    for w=1:12
       ...
       for v=1:size(tempHlecc150)
           for u=1:size(tempQlcon150)
                if(tempHlecc150(v,3) == tempQlcon150(u,3))
                   %if (tempHlecc150(v,2) == tempQlcon150(u,2))
    ...
    for w=1:12
       ...
       for v=1:size(tempHrecc150)
           for u=1:size(tempQrcon150)
                if(tempHrecc150(v,3) == tempQrcon150(u,3))
                   %if (tempHrecc150(v,2) == tempQrcon150(u,2))
